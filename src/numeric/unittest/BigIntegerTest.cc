...
TEST(BigInteger, OperatorAdd)
{
	...
	auto sum = num1 + num2;
	ASSERT_EQ(sum.ToString(), "123456912");
	...
	sum = num1 + num2;
	ASSERT_EQ(sum.ToString(), "12345678901246912");
	...
	num2 = BigInteger::FromString(strNum2);
	sum = num1 + num2;
	ASSERT_EQ(sum.ToString(), "5859874482048838473822930854632165381954416493075065395941912219");
}
...
TEST(BigInteger, OperatorSub)
{
	...
	auto num2 = BigInteger::FromString(strNum2);
	auto diff = num1 - num2;
	ASSERT_EQ(diff.ToString(), "123456666");
	...
	num2 = BigInteger::FromString(strNum2);
	diff = num2 - num1;
	ASSERT_EQ(diff.ToString(), "12345678901222222");
	...
	num2 = BigInteger::FromString(strNum2);
	diff = num1 - num2;
	ASSERT_EQ(diff.ToString(), "423310825130748003102355911926840386439922305675146246007976965");
}
...
TEST(BigInteger, OperatorMul)
{
	...
	auto num2 = BigInteger::FromString(strNum2);
	auto mul = num1 * num2;
	ASSERT_EQ(mul.ToString(), "15185185047");
	...
	num2 = BigInteger::FromString(strNum2);
	mul = num1 * num2;
	ASSERT_EQ(mul.ToString(), "152407406035740729615");
	...
	num2 = BigInteger::FromString(strNum2);
	mul = num1 * num2;
	ASSERT_EQ(mul.ToString(), "35023184");
	...
	num2 = BigInteger::FromString(strNum2);
	mul = num1 * num2;
	ASSERT_EQ(mul.ToString(), "5018861482723184");
	...
	num2 = BigInteger::FromString(strNum2);
	mul = num1 * num2;
	ASSERT_EQ(mul.ToString(), "50851806767876401952806582723184");
	...
	num2 = BigInteger::FromString(strNum2);
	mul = num1 * num2;
	ASSERT_EQ(mul.ToString(), "180255854545876931315273184330549073013374895871952806582723184");
